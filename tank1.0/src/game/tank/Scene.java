...
public class Scene
{
    ...
    private Cell genMapElement(int type, int col, int row)
    {
        ...
        case Consts.ELEMENT_TYPE_WALL:
            element = new Cell(col * Consts.CS, row * Consts.CS,
                    Consts.ELEMENT_TYPE_WALL);
            break;

        case Consts.ELEMENT_TYPE_STEEL:
            element = new Cell(col * Consts.CS, row * Consts.CS,
                    Consts.ELEMENT_TYPE_STEEL);
            break;

        case Consts.ELEMENT_TYPE_BASE:
            element = new Cell(col * Consts.CS, row * Consts.CS,
                    Consts.ELEMENT_TYPE_BASE);
            break;

        case Consts.ELEMENT_TYPE_EDGE:
            element = new Cell(col * Consts.CS, row * Consts.CS,
                    Consts.ELEMENT_TYPE_EDGE);
            break;

        case Consts.ELEMENT_TYPE_WHITEFLAG:
            element = new Cell(col * Consts.CS, row * Consts.CS,
                    Consts.ELEMENT_TYPE_WHITEFLAG);
            break;

        case Consts.ELEMENT_TYPE_LAKE:
            element = new Cell(col * Consts.CS, row * Consts.CS,
                    Consts.ELEMENT_TYPE_LAKE);
            break;
        }
        return element;
    }
