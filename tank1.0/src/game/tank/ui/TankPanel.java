...
public class TankPanel extends JPanel
{
    ...
    private void initComponent()
    {
        ...
        text.setText("<html>如发现bug,或有建议,请联系我：<br/>326178099@qq.com</html>");
        ...
        ImageIcon selfIcon = new ImageIcon(getClass().getResource(
                "../image/self_icon.png"));
        ...
        ImageIcon btnIcon = new ImageIcon(getClass().getResource(
                "../image/button.png"));
        btn.setIcon(btnIcon);
