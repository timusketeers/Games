...
public class BulletFly
{
    ...
    public void flyBullet(Tank tank, Scene scene)
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < tankList.size(); i++)
            {
                ...
                if (tank.equals(t) || t.isAlive() == false
                        || Utils.checkIfTeammate(t, tank))
                {
                    continue;
                }
                ...
                if (t.getBullet() != null
                        && Utils.checkCollide(tank.getBullet(), t.getBullet()))
                {
                    tank.setBullet(null);
                    t.setBullet(null);
                    return;
            ...
            catch (Exception e)
            {
                ...
                if (tank.getBullet() == null)
                    System.out.println("bullet collide.[bullet]:"
                            + tank.getBullet());
                else
                    e.printStackTrace();
                return;
    ...
    public void bulletBlast(Tank tank, Tank collideObj, Scene scene)
    {
        ...
        int centerX = collideObj.getHorizon()
                + collideObj.getImg().getWidth(null) / 2;
        int centerY = collideObj.getVertical()
                + collideObj.getImg().getHeight(null) / 2;
